...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with versionRef 'androidx.compose.ui.test'.
        ...
        /**
         * Creates a dependency provider for androidxSqliteDriver (androidx.sqlite:sqlite-driver)
     * with versionRef 'androidx.sqlite'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroidxSqliteDriver() {
            return create("androidxSqliteDriver");
    }
     ...
     * with versionRef 'kotlin.test'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKotlinTestCommon() {
            return create("kotlinTestCommon");
    }
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        public AndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: android.gradlePlugin (8.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        public AndroidxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidx.navigationCompose (2.7.7)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidx.sqlite (2.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxComposeUiVersionAccessors vaccForAndroidxComposeUiVersionAccessors = new AndroidxComposeUiVersionAccessors(providers, config);
        public AndroidxComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.androidx.compose.ui
         */
        public AndroidxComposeUiVersionAccessors getUi() {
            return vaccForAndroidxComposeUiVersionAccessors;
        }

    }

    public static class AndroidxComposeUiVersionAccessors extends VersionFactory  {

        public AndroidxComposeUiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.compose.ui.test (1.6.7)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTest() { return getVersion("androidx.compose.ui.test"); }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("kotlin"); }
            ...
            /**
             * Returns the version associated to this alias: kotlin.test (1.9.22)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTest() { return getVersion("kotlin.test"); }
    ...
    public static class AndroidPluginAccessors extends PluginFactory {
        ...
        public AndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
             ...
             * with versionRef 'android.gradlePlugin'.
             * This plugin was declared in catalog libs.versions.toml
             */
